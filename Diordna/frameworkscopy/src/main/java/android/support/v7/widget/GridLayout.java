 ...
 * by their {@link android.support.v7.widget.GridLayout.LayoutParams#rowSpec rowSpec} and
 * {@link android.support.v7.widget.GridLayout.LayoutParams#columnSpec columnSpec} layout parameters.
 ...
 * {@link android.support.v7.widget.GridLayout#setOrientation(int) orientation},
 * {@link android.support.v7.widget.GridLayout#setRowCount(int) rowCount} and
 * {@link android.support.v7.widget.GridLayout#setColumnCount(int) columnCount} properties.
 *
 * <h4>Space</h4>
 *
 ...
 *
 * {@link android.view.ViewGroup.MarginLayoutParams#leftMargin leftMargin},
 * {@link android.view.ViewGroup.MarginLayoutParams#topMargin topMargin},
 * {@link android.view.ViewGroup.MarginLayoutParams#rightMargin rightMargin} and
 * {@link android.view.ViewGroup.MarginLayoutParams#bottomMargin bottomMargin}
 *
 * layout parameters. When the
 * {@link android.support.v7.widget.GridLayout#setUseDefaultMargins(boolean) useDefaultMargins}
 ...
 * {@link android.support.v7.widget.GridLayout.LayoutParams#setGravity(int) gravity} property of the child's layout parameters.
 ...
 * {@link android.view.View#GONE GONE}, as having zero width and height. This is subtly different from
 ...
 *
 * <p>
 * See {@link android.support.v7.widget.GridLayout.LayoutParams} for a full description of the
...
public class GridLayout extends ViewGroup {
     ...
     * value of each the upper bounds defined in {@link android.support.v7.widget.GridLayout.LayoutParams#rowSpec}.
     *
     * @return the current number of rows
     *
     * @see #setRowCount(int)
     * @see android.support.v7.widget.GridLayout.LayoutParams#rowSpec
     *
     * @attr ref android.R.styleable#GridLayout_rowCount
     */
     ...
     * value of each the upper bounds defined in {@link android.support.v7.widget.GridLayout.LayoutParams#columnSpec}.
     *
     * @return the current number of columns
     *
     * @see #setColumnCount(int)
     * @see android.support.v7.widget.GridLayout.LayoutParams#columnSpec
     *
     * @attr ref android.R.styleable#GridLayout_columnCount
     */
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        /** If we have been called by {@link android.view.View#measure(int, int)}, one of width or height
     ...
     * {@link android.support.v7.widget.GridLayout.Spec Specs} are immutable structures
     ...
     * alignment within its cell group by using the {@link android.support.v7.widget.GridLayout.LayoutParams#setGravity(int)}
     * method.
     * <p>
     ...
     * as discussed in {@link android.support.v7.widget.GridLayout}.
     *
     * <h4>Summary</h4>
     *
     ...
     *          {@link android.support.v7.widget.GridLayout#setUseDefaultMargins(boolean) useDefaultMargins} is
     ...
     * </ul>
     *
     * See {@link android.support.v7.widget.GridLayout} for a more complete description of the conventions
    ...
    public static class LayoutParams extends MarginLayoutParams {
         ...
         * {@link android.view.ViewGroup#setLayoutParams(android.view.ViewGroup.LayoutParams)}
         ...
         * default values as defined in {@link android.support.v7.widget.GridLayout.LayoutParams}.
         *
        ...
        /**
         * Constructs a new LayoutParams with default values as defined in {@link android.support.v7.widget.GridLayout.LayoutParams}.
         */
        public LayoutParams() {
         ...
         * defined in {@link android.support.v7.widget.GridLayout.LayoutParams}.
         */
    ...
    */
     ...
     * See {@link android.support.v7.widget.GridLayout} for a description of the conventions used by GridLayout
     * for grid indices.
     * <p>
     ...
     *   <li>{@link #spec(int, android.support.v7.widget.GridLayout.Alignment)}</li>
     *   <li>{@link #spec(int, int, android.support.v7.widget.GridLayout.Alignment)}</li>
     *   <li>{@link #spec(int, float)}</li>
     *   <li>{@link #spec(int, int, float)}</li>
     *   <li>{@link #spec(int, android.support.v7.widget.GridLayout.Alignment, float)}</li>
     *   <li>{@link #spec(int, int, android.support.v7.widget.GridLayout.Alignment, float)}</li>
     * </ul>
     *
     */
     ...
     * @param alignment the alignment
     *
     * @see #spec(int, int, android.support.v7.widget.GridLayout.Alignment)
     */
     ...
     * @param size      the size
     *
     * @see #spec(int, android.support.v7.widget.GridLayout.Alignment)
     */
     ...
     * <p>
     * The {@link android.support.v7.widget.GridLayout.LayoutParams} class contains a {@link android.support.v7.widget.GridLayout.LayoutParams#rowSpec rowSpec}
     * and a {@link android.support.v7.widget.GridLayout.LayoutParams#columnSpec columnSpec} each of which contains an
     ...
     * This constant may be used in both {@link android.support.v7.widget.GridLayout.LayoutParams#rowSpec rowSpecs} and {@link
     * android.support.v7.widget.GridLayout.LayoutParams#columnSpec columnSpecs}.
     */
     ...
     * This constant may only be used as an alignment in {@link android.support.v7.widget.GridLayout.LayoutParams#rowSpec rowSpecs}.
     *
     ...
     * This constant may be used in both {@link android.support.v7.widget.GridLayout.LayoutParams#rowSpec rowSpecs} and
     * {@link android.support.v7.widget.GridLayout.LayoutParams#columnSpec columnSpecs}.
     */
