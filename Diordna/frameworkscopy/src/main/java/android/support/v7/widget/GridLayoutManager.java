 ...
 * {@link android.support.v7.widget.GridLayoutManager.SpanSizeLookup} instance via {@link #setSpanSizeLookup(android.support.v7.widget.GridLayoutManager.SpanSizeLookup)}.
 */
public class GridLayoutManager extends LinearLayoutManager {
     ...
     *
     * @param spanSizeLookup {@link android.support.v7.widget.GridLayoutManager.SpanSizeLookup} instance to be used to query number of spans
    ...
    /**
     * Returns the current {@link android.support.v7.widget.GridLayoutManager.SpanSizeLookup} used by the GridLayoutManager.
     *
     * @return The current {@link android.support.v7.widget.GridLayoutManager.SpanSizeLookup} used by the GridLayoutManager.
     */
    ...
    /**
     * Default implementation for {@link android.support.v7.widget.GridLayoutManager.SpanSizeLookup}. Each item occupies 1 span.
     */
