 ...
 *
 * <p>A Toolbar is a generalization of {@link android.support.v7.app.ActionBar action bars} for use
 ...
 * using the {@link android.support.v7.app.ActionBarActivity#setSupportActionBar(android.support.v7.widget.Toolbar)
 ...
 *     {@link android.support.v7.widget.Toolbar.LayoutParams} indicates a {@link android.view.Gravity} value of
 *     {@link android.view.Gravity#CENTER_HORIZONTAL CENTER_HORIZONTAL} the view will attempt to center
 *     within the available space remaining in the Toolbar after all other elements have been
 *     measured.</li>
 *     <li><em>An {@link android.support.v7.widget.ActionMenuView action menu}.</em> The menu of actions will pin to the
...
public class Toolbar extends ViewGroup {
     ...
     * ActionBar API. See
     * {@link android.support.v7.app.ActionBarActivity#setSupportActionBar(android.support.v7.widget.Toolbar)
