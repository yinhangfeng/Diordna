 ...
 * <p>
 * Views given to the Gallery should use {@link diordna.widget.Gallery.LayoutParams} as their
 ...
 * widgets include {@link android.widget.HorizontalScrollView} and {@link android.support.v4.view.ViewPager}
...
public class Gallery extends AbsSpinner implements GestureDetector.OnGestureListener {
    ...
    void trackMotionScroll(int deltaX) {
        ...
        //1.将所有子view 左右方向移动limitedDeltaX(相比于ListView 先回收再移动 缺点是被回收的view也进行了无必要的调整)
    ...
    /**
     * 将超出Gallery范围的view加入mRecycler 并从Gallery移除
    ...
    /**
     * 调用mFlingRunnable 将mSelectedChild滚动到中间
    ...
    void onUp() {
        ...
        if (mFlingRunnable.mScroller.isFinished()) {
            //当前不处于fling 滚动当前选中view(最靠近中心的)到中间
            scrollIntoSlots();
        }
    ...
    private class FlingRunnable implements Runnable {
        ...
        /**
         * 结束fling
         * @param scrollIntoSlots 是否需要件选中item滚到中心
         */
