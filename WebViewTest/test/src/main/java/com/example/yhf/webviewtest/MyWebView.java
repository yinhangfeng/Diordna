...
public class MyWebView extends WebView {
    ...
    private void init() {
        ...
        tv.setText("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
        tv.setTextSize(16);
        WebView.LayoutParams layoutParams = new WebView.LayoutParams(WebView.LayoutParams.MATCH_PARENT, 300, 0, 300);
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        Log.i(TAG, "addView() called with " + "child = [" + child.getClass() + "], index = [" + index + "], params = [" + params + "]");
